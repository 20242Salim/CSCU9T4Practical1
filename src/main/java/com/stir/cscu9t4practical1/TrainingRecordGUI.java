// GUI and main program for the Training Record updated by
...
private TrainingRecordGUI myAthletes = new TrainingRecordGUI();
...
void addEntry(Entry e) {
 ...
 String lookupEntry(int d, int m, int y) {
 // TODO Auto-generated method stub
 return null;
 }
 ...
 String message = myAthletes.lookallEntry();
 return message;
    }
 ...
 int d = Integer.parseInt(day.getText());
 int y = Integer.parseInt(year.getText());
 outputArea.setText("remoivg all record...");
 String message = myAthletes.removeEntry(n, d, m, y);
 return message;
 }
 private String removeEntry(String n, int d, int m, int y) {
 // TODO Auto-generated method stub
return null;
 }
